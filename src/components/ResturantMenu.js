...
import { RESTURANT_MENU_IMG_URL, RESURANT_MENU_API } from "../utils/constants";
import { RESURANT_MENU_API } from "../utils/constants";
...
const ResturantMenu = () => {
  ...
  const fetchMenu = async () => {
    const menuData = await fetch(RESURANT_MENU_API + resId);
